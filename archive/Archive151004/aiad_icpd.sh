...
# lig2_csv="lig2.csv"
# 
# echo "num,atom,x,y,z" > $lig1_csv
# echo "num,atom,x,y,z" > $lig2_csv
# 
# # cat $lig1_pdbqt | 
# # grep 'HETATM' |
# # tr -s ' ' ',' | 
...
# >> $lig2_csv
# 
# python /Users/zarek/lab/scriptz/aiad_icpd.py $lig1_csv $lig2_csv $option
# 
...
lig1_csv="lig1.csv.tmp.txt"
lig2_csv="lig2.csv.tmp.txt"
