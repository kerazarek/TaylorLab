...
from pose_clustering import cluster_poses
from postdocking_summary import * # write_summary_csv
from dockings_and_gridboxes import *
...
def main():
	...
	parser.add_argument('-m', '--summary', action='store_true', default=False,
		help='create post-dcking summary table')
...
# 		new_grid_or_dock_entry.new_docking_entry()
		...
		if args['summary']: d.write_summary_csv()
